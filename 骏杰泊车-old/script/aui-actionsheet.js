        ...
        open: function(params,callback) {
            ...
            if(self.buttons && self.buttons.length){
                for(var i = 0; i < self.buttons.length;i++){
                    if(self.activeIndex && (self.activeIndex-1) == i){
                        var activeClass = "aui-active";
                    }else{
                        var activeClass = "";
                    }
                    if(i == self.buttons.length-1){
                        buttonsHtml += '<div class="aui-actionsheet-btn-item '+activeClass+'">'+self.buttons[i]+'</div>';
                    }else{
                        buttonsHtml += '<div class="aui-actionsheet-btn-item '+activeClass+' aui-border-b">'+self.buttons[i]+'</div>';
                    }
                }
            }
