        ...
        open: function(params,callback) {
            ...
            if(self.buttons && self.buttons.length){
                ...
                for(var i = 0; i < self.buttons.length;i++){
                    ...
                    if(self.imageWidth){
                        if(self.buttons[i].image)buttonsHtml += '<img src="'+self.buttons[i].image+'" style="width:'+self.imageWidth+'">';
                    }else{
            ...
            if(document.querySelector(".aui-sharebox-close-btn"))document.querySelector(".aui-sharebox-close-btn").onclick = function(){
                if(callback){
                    callback({
                        buttonIndex: 0
                    });
